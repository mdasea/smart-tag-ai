...
type RouteFiles = {
  ...
  "routes/api.ingest-product.tsx": {
    id: "routes/api.ingest-product";
    page: "/api/ingest-product";
  };
...
type RouteModules = {
  ...
  "routes/api.ingest-product": typeof import("./app/routes/api.ingest-product.tsx");
  "routes/api.webhooks": typeof import("./app/routes/api.webhooks.tsx");
